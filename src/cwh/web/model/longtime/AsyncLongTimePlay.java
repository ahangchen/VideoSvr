        ...
        SessionManager.getInstance().requestVideo(tsDir.replace(CommonDefine.DATA_PATH + File.separator, "") + File.separator + CommonDefine.LONG_TIME_M3U8,
                sessionState, new SessionManager.CacheCallback() {
                    ...
                    public boolean onNew(RequestState requestState) {
                        ...
                        final int seq = timeIntervals.length * 2;
                        NvrService.getInstance().time2VideoPath(
                                ...
                                new PlayCallback() {
                                    ...
                                    public void onComplete(String filePath) {
                                        ...
                                        tsIndex[0] = firstM3U8(firstM3U8, longTimeM3U8Path, tsDir, seq);
...
//        -segment_time 2
    ...
    public static int firstM3U8(String partPath, String wholePath, final String tsDir, final int seq) {
        final int[] tsIndex = new int[1];
        tsIndex[0] = 0;
        String buf = ("#EXTM3U\n" +
                "#EXT-X-VERSION:3\n" +
...
//                seq +
        ...
        FileUtils.append2File(wholePath, buf);
